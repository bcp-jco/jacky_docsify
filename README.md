...
I am also the team lead in the R&D department. Inside our team, we will do the tools necessary to boost any projects.The scripts consist a mixture of c# zero torch node, revit API,Ironpython node from our own and also dynamo packages. Feel free to take a took of the tools I made.
Please noticed that this site is just for interal usage.I have also hidden some of the demo base on confidentiality. If you are intreasted feel free to contact jackyluk95@gmail.com.
